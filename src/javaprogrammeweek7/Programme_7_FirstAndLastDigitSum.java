 ...
 * *	sumFirstAndLastDigit(257); →should return 9, the first digit is 2 and the last is 7 which gives us 2+7 and the sum is 9. * sumFirstAndLastDigit(0); → should return 0, the first digit and the last digit is 0 since we only have 1 digit, which
...
public class Programme_7_FirstAndLastDigitSum {
    public static int sumFirstAndLastDigit(int number) {
        ...
        System.out.println("Sum is :" + (number + lastDigit));
